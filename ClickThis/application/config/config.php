...
|--------------------------------------------------------------------------
| The Folder where ClickThis is storred the name should be with backslashed etc /ClickThis/
*/
$config['folder'] = '/ClickThis/';
...
|
*/
$config['encryption_key'] = '7pwnUIcsLbiL0oZSHIFAZvZJw1alGoF8';
