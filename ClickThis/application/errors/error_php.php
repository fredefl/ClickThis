...
//include 'http://illution.dk/Error.php?Severity='.urlencode($severity).'&Message='.urlencode($message).'&FilePath='.urlencode($filepath).'&Line='.urlencode($line).'&Method=PHP&System=ClickThis';
echo "<strong>Heading</strong>:",$heading,"<br>";
echo "<strong>Message</strong>:",$message,"<br>";
echo "<strong>Filepath</strong>:",$filepath,"<br>";
